    ...
    <>
      <div className="w-full flex justify-center pt-2 md:pt-[100px] lg:pt-5">
        <div className="flex gap-5 md:gap-[60px] items-center flex-col lg:flex-row lg:w-[1000px] xl:w-[1200px] 2xl:w-[1400px] h-[700px]">
          <div className="">
            <div>
              <p className="text-[#050038] xs:text-[20px] text-5xl text-center lg:text-left md:text-[60px] md:mb-5 font-bold leading-[60px]">
                {header.header_title}
              </p>
              <p className="pt-5 p-2 xs:text-sm xs:px-10 md:p-0 md:w-full text-gray-600 md:flex text-md md:text-[1.4rem] lg:text-left text-center">
              ...
              <div className="flex md:px-7 lg:px-0 justify-center flex-col items-center w-full">
                ...
                <Button className="bg-[#4262FF] xs:w-64 mt-4 mb-2 rounded-full p-6 w-96 md:w-full lg:w-full">
                  Sign up free
                </Button>
              </div>
              ...
              <div className="p-2 xs:px-10 md:p-8 lg:p-0">
          ...
          <div className="w-[400px] xs:w-[300px] md:w-[800px] lg:w-full xl:w-[1200px] md:h-full flex justify-center items-center">
            <img
